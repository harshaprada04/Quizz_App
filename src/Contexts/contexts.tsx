...
const Context = createContext({
  ...
  getPreviousElement: (currentId: number) => {},
  getNextElement: (currentId: number) => {},
});
...
export function ContextProvider(props: any) {
  ...
  function getPreviousElement(currentId: number) {
    const currentIndex = questionList.findIndex(
      (question: any) => question.id === currentId
    );
    if (currentIndex > 0) {
  ...
  function getNextElement(currentId: number) {
    const currentIndex = questionList.findIndex(
      (question: any) => question.id === currentId
    );
